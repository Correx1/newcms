...
import { ArrowLeft, Loader2, Send, Save, Receipt, DollarSign, Folders } from "lucide-react"
...
export default function InvoiceGeneratorPage() {
  ...
  const saveInvoiceToDatabase = async (sendEmail: boolean = false) => {
    ...
    sendEmail ? setSending(true) : setSaving(true)
    ...
    try {
      ...
      toast.success(sendEmail ? "Invoice Generated and Dispatched Securely" : "Invoice Saved to Client Dashboard")
    ...
    <div className="flex-1 space-y-6 pt-6 pb-12 w-full max-w-5xl mx-auto px-4 animate-in fade-in duration-500">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm font-medium">Dynamically aggregate projects and line items into authentic client bills.</p>
        </div>
      </div>
          ...
          <Card className="shadow-sm border-border/50">
            ...
            <CardFooter className="flex-col gap-3 bg-muted/5 border-t border-border/50 pt-6">
              ...
              >
                ...
                Publish & Dispatch to Client Email
              </Button>
              <Button 
